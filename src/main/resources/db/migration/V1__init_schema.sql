...
-- =============================================================================
-- This table stores product categories for each tenant
...
CREATE TABLE IF NOT EXISTS product_categories (
    ...
    -- Ensure unique category names per tenant (enforced by tenant schema isolation)
    UNIQUE (name)
);

-- Create index for better performance
CREATE INDEX IF NOT EXISTS idx_categories_active_sort ON product_categories (is_active, sort_order, name);
